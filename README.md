**NOTE**: This branch is the combination of several PRs on top of the official 3.3.3 release. It is dedicated to test [Dear ImGui](https://github.com/ocornut/imgui) features in development (e.g viewport and docking). This branch is compiled regularly under macOS 10.5 and Windows 10.
