**NOTE**: This branch is the combination of several PRs on top of the official 3.3.2 release. It is dedicated to test [Dear ImGui](https://github.com/ocornut/imgui) features in development (e.g viewport and docking). This branch is compiled regularly under macOS 10.14.6 and Windows 10.

**PR merged in this repository**
